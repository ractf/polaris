...
public class Namespace extends JsonRepresentable {
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equals(name, namespace.name) && Objects.equals(hasResourceLimit, namespace.hasResourceLimit) && Objects.equals(maxCpu, namespace.maxCpu) && Objects.equals(maxMemory, namespace.maxMemory) && Objects.equals(allocatedCpu, namespace.allocatedCpu) && Objects.equals(allocatedMemory, namespace.allocatedMemory) && Objects.equals(allowedCapAdd, namespace.allowedCapAdd) && Objects.equals(allowedCapDrop, namespace.allowedCapDrop);
    }

    @Override
    public int hashCode() {
        return Objects.hash(name, hasResourceLimit, maxCpu, maxMemory, allocatedCpu, allocatedMemory, allowedCapAdd, allowedCapDrop);
    }
}
