...
public class TaskDeleteResponse extends JsonRepresentable {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof TaskDeleteResponse)) return false;
        final TaskDeleteResponse that = (TaskDeleteResponse) o;
