...
public class NodeAffinityTest {
    ...
    private final NodeAffinity nodeAffinity = new NodeAffinity();

    @Test
    public void testName() {
        assertThat(nodeAffinity.getName()).isEqualTo("NodeAffinity");
    }
    ...
    public void testAffinityBlankMatch() {
        ...
        final var result = nodeAffinity.filter(task, node);
